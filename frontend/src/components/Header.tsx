    ...
    <header className="bg-slate-900 border-b border-slate-700 shadow-lg sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="p-2 bg-gradient-to-br from-dark-500 to-dark-700 rounded-lg shadow-glow">
            <Shield className="w-6 h-6 text-dark-100" />
          </div>
          <div>
            <h1 className="text-2xl font-bold text-dark-400">Aegis-AI</h1>
            <p className="text-xs text-slate-400">Cybersecurity Assistant</p>
          </div>
        </div>
