...
export function ReportPanel({ onGenerate, generating }: ReportPanelProps) {
  return (
    <div className="card-glow p-6">
      <h3 className="text-lg font-semibold text-slate-100 mb-4">Generate Executive Report 📄</h3>
      <p className="text-slate-400 text-sm mb-4">
        Create polished incident summaries, risk highlights, and prioritized recommendations.
      </p>
